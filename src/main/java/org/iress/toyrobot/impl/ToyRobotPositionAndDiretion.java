 ...
 */
public class ToyRobotPositionAndDiretion {
     ...
     * @param position
     */
    public ToyRobotPositionAndDiretion(ToyRobotPositionAndDiretion position) {
     ...
     * @param direction
     */
    public ToyRobotPositionAndDiretion(int x, int y, Directions direction) {
     ...
     */
    public ToyRobotPositionAndDiretion computePosition() throws ToyRobotException {
